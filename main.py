...
class Gym(tk.Tk):
    def __init__(self, *a,**b):
        ...
        self.title(' Gym Management')
        #self.configure(bg='black')
        self.geometry('1850x1625')
        l1 = tk.Label(self, text = 'Welcome to  Gym Centers', font=("Courier", 38, "bold"), bg='white',fg="green").pack()
        ...
        for F in ( Menu, AddCustomer,  ShowCustomers, ShowPackages,  AddSubscription, AddPayment):
...
class Menu(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        #self.configure(bg=PhotImage(file="bg.png"))
        #label1 = Label(self, image=bg)
        #label1.place(x=0, y=0)

        label = tk.Label(self, text = 'Start Menu', font=("Helvetica", 30, "italic"),bg="grey" ).pack(pady=24, padx=10)
        b1 = tk.Button(self, text = 'Add Customer', relief='raised', font=("Times", 18), width=20,bg="black",fg="white", command=lambda : controller.show_frame(AddCustomer)).pack(pady=4)

        b3 = tk.Button(self, text = 'Show All Customers', relief='raised', font=("Times", 18), width=20,bg="green",fg="black", command=lambda: controller.show_frame(ShowCustomers)).pack(pady=4)
        b4 = tk.Button(self, text = 'Show All Packages', relief='raised', font=("Times", 18), width=20,bg="white",fg="black", command=lambda: controller.show_frame(ShowPackages)).pack(pady=4)
        b5 = tk.Button(self, text = 'Add Subscription', relief='raised', font=("Times", 18), width=20,fg="black",bg="red", command=lambda: controller.show_frame(AddSubscription)).pack(pady=4)
        b6 = tk.Button(self, text = 'Add Payment', relief='raised', font=("Times", 18), width=20,bg="black",fg="white", command=lambda: controller.show_frame(AddPayment)).pack(pady=4)
...
class AddCustomer(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text = 'Add Customer', font=("Helvetica", 30, "bold"), bg='yellow').pack(pady=10, padx=10)
        ...
        success = tk.Label(self, text = '', font=("Helvetica", 14, "bold"), bg='yellow', textvariable = self.text).pack(pady=6, padx=10)
...
class ShowCustomers(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text = 'List of Customers', font=("Helvetica", 30, "italic"), bg='skyblue').pack(padx=10)

        list1 = tk.Listbox(self, height=10, width=160, selectmode='multiple', font=("Times", 28), bd = 6, relief='raised', bg='blue', fg='#2C3335')
...
class ShowPackages(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        list1 = tk.Listbox(self, height=8, width=160, selectmode='multiple', font=("Times", 28), bd = 6, relief='raised', bg='white',fg='#2C3335')
        list1.pack(padx=25, pady=16)
        b2 = tk.Button(self, text = 'Menu', relief='raised', font=("Times", 18), width=10, command=lambda: controller.show_frame(Menu)).pack()
        self.view_command(list1)
